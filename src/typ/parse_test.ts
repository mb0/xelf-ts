...
let tests:[string, Type, string][] = [
	...
	['int@1?', typ.var(1, typ.opt(typ.int)), ''],
	['list', typ.list, ''],
	['<list>', typ.list, 'list'],
	...
	['<func int@ bool>', typ.func({typ: typ.var(-1, typ.int)}, {typ: typ.bool}), ''],
	['<func int _>', typ.func({typ: typ.int}, {typ: typ.sel('.0')}), ''],
	['<func int@ _>', typ.func({typ: typ.var(-1, typ.int)}, {typ: typ.sel('.0')}), ''],
	...
	['<obj? id:int count:_>', typ.opt(typ.obj({name:"id", typ:typ.int}, {name:"count", typ:typ.sel('.0')})), ''],
	...
	['list@1?|int@2?', typ.var(1, typ.opt(typ.listOf(typ.var(2, typ.opt(typ.int))))), ''],
	['<alt@1 int str>', typ.var(1, typ.alt(typ.int, typ.str)), ''],
	['<list@1?|alt@2? int str>', typ.var(1, typ.opt(typ.listOf(typ.var(2, typ.opt(typ.alt(typ.int, typ.str)))))), ''],
